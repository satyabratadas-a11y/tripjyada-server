...
function serializeClient(client, req) {
  return {
    ...
    myRole: req.user.role === 'admin' ? 'owner' : client.roleFor(req.user._id),
...
const CLIENT_FIELDS = ['name', 'brandColor', 'logoUrl', 'industry', 'businessType', 'description', 'status'];
...
async function updateClient(req, res) {
  const update = pickWhitelisted(req.body, CLIENT_FIELDS);
